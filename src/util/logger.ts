...
// loaded LOG_LEVEL so module-scope consumers (e.g. voice/connect.ts) emit at the configured
// level instead of a hardcoded-"info" instance that ignores LOG_LEVEL entirely.
